...
<div class="container">
    ...
    <?php if($today < $trip->startdate){ ?><p>You go on <?= $trip->startdate?></p> <?php ;}
            else{?> <p>You went on <?= $trip->startdate?></p><?php ;}?>
    <?php if($today > $trip->enddate){ ?><p>Coming back on <?= $trip->enddate?></p> <?php ;}
            else{?> <p>You came back on <?= $trip->enddate?></p><?php ;}?>
    <?php if($today < $trip->enddate){ ?><h3>What you are going to do</h3> <?php ;}
            else{?>
                <br>
                <h3>What you did </h3><?php ;}?>
                <br>
    <p><?= $trip->notes?></p>
                <br>
